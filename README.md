...
| Dashboards | http://localhost:5601 | OpenSearch Dashboards (opt-in: installer flag `--enable-dashboards`/`-EnableDashboards`, or `COMPOSE_PROFILES=dashboards` + `DASHBOARDS_ENABLED=true` in the `.env`) |
